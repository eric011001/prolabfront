      ...
      <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div className="grid grid-cols-3 gap-4 mb-4">
          <div className="flex flex-col items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
            ...
            <dd className="text-gray-500 dark:text-gray-400">Sesiones Activas</dd>
          </div>
          <div className="flex flex-col items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
            <dt className="mb-2 text-3xl font-extrabold">25</dt>
            <dd className="text-gray-500 dark:text-gray-400">Jugadores registrados</dd>
          </div>
          <div className="flex flex-col items-center justify-center h-24 rounded bg-gray-50 dark:bg-gray-800">
            <dt className="mb-2 text-3xl font-extrabold">50</dt>
            <dd className="text-gray-500 dark:text-gray-400">Actividades asignadas</dd>
          </div>
        </div>
